	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((e.getSource())==btnCalcular)
		{
			if(comprobarJTextFieldsNain()) {
				Ej04_Punto punto1=new Ej04_Punto(Double.parseDouble(p1X.getText()),Double.parseDouble(p1Y.getText()));
				Ej04_Punto punto2=new Ej04_Punto(Double.parseDouble(p2X.getText()),Double.parseDouble(p2Y.getText()));
				Ej04_Punto punto3=new Ej04_Punto(Double.parseDouble(p3X.getText()),Double.parseDouble(p3Y.getText()));
				double perimetro=Ej04_Punto.distancia2Puntos(punto1, punto2)+Ej04_Punto.distancia2Puntos(punto2,punto3)+Ej04_Punto.distancia2Puntos(punto3,punto1);
