...
public class Perimetro extends JFrame implements ActionListener,KeyListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((e.getSource())==btnCalcular)
		{
			if(comprobarJTextFieldsNain()) {
				PerimetroPuntos punto1=new PerimetroPuntos(Double.parseDouble(p1X.getText()),Double.parseDouble(p1Y.getText()));
				PerimetroPuntos punto2=new PerimetroPuntos(Double.parseDouble(p2X.getText()),Double.parseDouble(p2Y.getText()));
				PerimetroPuntos punto3=new PerimetroPuntos(Double.parseDouble(p3X.getText()),Double.parseDouble(p3Y.getText()));
				double perimetro=PerimetroPuntos.distancia2Puntos(punto1, punto2)+PerimetroPuntos.distancia2Puntos(punto2,punto3)+PerimetroPuntos.distancia2Puntos(punto3,punto1);
