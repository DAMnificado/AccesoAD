...
public class Ej4_swing extends JFrame implements ActionListener,KeyListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ((e.getSource())==btnCalcular)
		{
			if(comprobarJTextFieldsNain()) {
				Ej4_Punto punto1=new Ej4_Punto(Double.parseDouble(p1X.getText()),Double.parseDouble(p1Y.getText()));
				Ej4_Punto punto2=new Ej4_Punto(Double.parseDouble(p2X.getText()),Double.parseDouble(p2Y.getText()));
				Ej4_Punto punto3=new Ej4_Punto(Double.parseDouble(p3X.getText()),Double.parseDouble(p3Y.getText()));
				double perimetro=Ej4_Punto.distancia2Puntos(punto1, punto2)+Ej4_Punto.distancia2Puntos(punto2,punto3)+Ej4_Punto.distancia2Puntos(punto3,punto1);
